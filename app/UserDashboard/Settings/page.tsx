    ...
    return (
        <>
            ...
            <div
                className={
                    userNav
                        ? "fixed left-0 top-0 w-full h-screen bg-black/70 z-[200]"
                        : ""
                }
            >
                <div
                    className={
                        userNav
                            ? "d-block fixed right-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] py-10 ease-in duration-500"
